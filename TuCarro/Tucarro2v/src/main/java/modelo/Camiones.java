...
public class Camiones extends Padre {
   ...
   public Camiones(String foto,int capacidadCarga, Poseer aireAcondiconado, Poseer frenosAire, Poseer abs, int numeroEjes, TipoCamion tipoCamion, int matricula, String marca, int modelo, int cilindraje, EstadoUso estadoUso, Combustible combustible, int velocidadMax, int cambios, Transmision transmision, int numeroPasajeros, int numeroPuertas, int numeroBolsaAire, Poseer poseer, Poseer camaraReserva, Poseer aireAcondicionado) {
